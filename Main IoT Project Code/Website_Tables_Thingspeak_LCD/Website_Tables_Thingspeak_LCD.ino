/*  
  ...
  LCD code was also added to display the sensor readings.
  Code Source: Example given by lecturer. The code has been edited to fit my website with my sensors and ThingSpeak.
*/
