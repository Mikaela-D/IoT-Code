...
#define PHONE_NUMBER  "0892559237" //number you are texting to

//The content of messages sent
#define MESSAGE  "hello,from ESP32"
const int PWR_PIN = 23; // if you want a SW reboot of Sim808

const char* ssid = "realme7_5G"; //realme7_5G  VM1493700
const char* password = "martesol8"; //martesol8  Xhxddt6jkmad
...
<body>
    <div id='main'>
        <h1 style="font-size: 250%;">Health-Tracking Webpage with ESP32 Server</h1>
        <div class="flex-container img">
            <p><b><i>Welcome to your Homepage</i></b></p>
            <a data-flickr-embed="true"
                href="https://www.flickr.com/photos/197718689@N03/52696081361/in/dateposted-public/"
                title="Project Image">
                <div>
                    <img src="https://live.staticflickr.com/65535/52696081361_533bc99af1_z.jpg" style="width:30%"
        ...
        <div>
            ...
            <p>Send Location Button</p>
           <p><a href="/on"><button class="button">SMS</button></a></p>
           </div>
    </div>
</body>
)====="));
